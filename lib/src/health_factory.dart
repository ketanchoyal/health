...
class HealthFactory {
  ...
  /// * [metaDataKeySyncIdentifier] - This is a string that is used to identify the data if you want to delete it.
  ...
  Future<bool> writeHealthData(
    ...
    DateTime endTime, {
    HealthDataUnit? unit,
    String? metaDataKeySyncIdentifier,
  }) async {
    ...
    Map<String, dynamic> args = {
      ...
      'metaDataKeySyncIdentifier': metaDataKeySyncIdentifier,
    };
    bool? success = await _channel.invokeMethod('writeData', args);
    return success ?? false;
  }

  /// Delete health data into Apple Health
  ///
  /// Returns true if successful, false otherwise.
  ///
  /// Parameters:
  /// * [type] - the value's HealthDataType
  /// * [metaDataKeySyncIdentifier] - This is a string that is used to identify the data you want to delete.
  /// + This is only implemented for iOS.
